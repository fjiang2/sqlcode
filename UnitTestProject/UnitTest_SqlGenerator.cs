...
namespace UnitTestProject
{
	...
	public class UnitTest_SqlGenerator
	{
		...
		public void Test_INSERT()
		{
			...
			Debug.Assert(SQL == "INSERT INTO [Categories]([CategoryName],[Description],[Picture]) VALUES('Drink','Water',0x0102030405060708)");

			SQL = gen.InsertWithIdentityParameter();
			Debug.Assert(SQL == "INSERT INTO [Categories]([CategoryName],[Description],[Picture]) VALUES('Drink','Water',0x0102030405060708); SET @CategoryID=@@IDENTITY");

			SQL = gen.InsertOrUpdate();
			Debug.Assert(SQL == "IF EXISTS(SELECT * FROM [Categories] WHERE [CategoryID] = 12) UPDATE [Categories] SET [CategoryName] = 'Drink',[Description] = 'Water',[Picture] = 0x0102030405060708 WHERE [CategoryID] = 12 ELSE INSERT INTO [Categories]([CategoryName],[Description],[Picture]) VALUES('Drink','Water',0x0102030405060708)");

			SQL = gen.InsertIfNotExists();
			Debug.Assert(SQL == "IF NOT EXISTS(SELECT * FROM [Categories] WHERE [CategoryID] = 12) INSERT INTO [Categories]([CategoryName],[Description],[Picture]) VALUES('Drink','Water',0x0102030405060708)");

			SQL = gen.InsertOrUpdate(exists: true);
			Debug.Assert(SQL == "UPDATE [Categories] SET [CategoryName] = 'Drink',[Description] = 'Water',[Picture] = 0x0102030405060708 WHERE [CategoryID] = 12");
		...
		public void Test_UPDATE()
		{
			...
			SQL = gen.UpdateIfExists();
			Debug.Assert(SQL == "IF EXISTS(SELECT * FROM [Categories] WHERE [CategoryID] = 12) UPDATE [Categories] SET [CategoryName] = 'Drink',[Description] = 'Water',[Picture] = 0x0102030405060708 WHERE [CategoryID] = 12");
		...
		public void Test_AddRange()
		{
			...
			SQL = gen.Update();
			Debug.Assert(SQL == "UPDATE [Categories] SET [CategoryName] = 'Drink' WHERE [CategoryID] = 12");
			...
			SQL = gen.Update();
			Debug.Assert(SQL == "UPDATE [Categories] SET [C1] = 12,[C2] = 'Drink',[C3] = 'Water' WHERE [CategoryID] = 12");
		}
	}
}

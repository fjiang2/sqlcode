...
namespace Sys.Data.Text
{
	public partial class Expression
	{
		...
		public static Expression CAST(Expression expr, TYPE type) => Function("CAST", new BinaryExpression(expr, "AS", new Expression(type)));
		...
		public static Expression CONVERT(TYPE type, Expression expr) => Function("CONVERT", new Expression(type), expr);
		...
		public static Expression DATEFROMPARTS(Expression year, Expression month, Expression day) => Function("DATEFROMPARTS", year, month, day);
		...
		public Expression ISDATE() => Function("ISDATE", this);
		public Expression DAY() => Function("DAY", this);
		public Expression MONTH() => Function("MONTH", this);
		public Expression YEAR() => Function("YEAR", this);
		...
		public Expression IIF(Expression yes, Expression no) => Function("IIF", this, yes, no);
		...
		public Expression NULLIF(Expression value) => Function("NULLIF", this, value);

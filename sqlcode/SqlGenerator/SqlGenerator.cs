...
namespace Sys.Data
{
    ...
    public class SqlGenerator : SqlColumnValuePairCollection
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string SelectColumns() => SelectColumns("*");
        ...
        /// <returns></returns>
        public string SelectColumns(IEnumerable<string> columns)
        {
            ...
            return SelectColumns(L1);
        }

        private string SelectColumns(string columns) => template.Select(columns);

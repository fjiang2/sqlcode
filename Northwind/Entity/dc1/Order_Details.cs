...
namespace Northwind.Entity.dc1
{
	...
	public static class Order_DetailsExtension
	{
		...
		public static Order_DetailsAssociation GetAssociation(this Order_Details entity, IDbQuery query)
		{
			return GetAssociation(new Order_Details[] { entity }, query).FirstOrDefault();
		}
		
		public static IEnumerable<Order_DetailsAssociation> GetAssociation(this IEnumerable<Order_Details> entities, IDbQuery query)
		{
